...
func init() {
	...
	flag.BoolVar(&runInIronichMode, "ironic-mode", false,
		"use the redfish provisioner to deploy nodes")
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	c, err := controller.New("metalkube-baremetalhost-controller", mgr,
		controller.Options{Reconciler: r, MaxConcurrentReconciles: 5})
	if err != nil {
		return err
	}
